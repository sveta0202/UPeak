(function () {
  ...
  var DICT = {
    ru: {
      ...
      "planner.tasks.reorderHint": "Перетаскивайте задачи за ручку ⋮⋮ слева, чтобы выстроить удобный порядок.",
      ...
      "planner.evening.procrastination": "Сегодня: насколько часто вы откладывали начало задач до позже?",
      "planner.evening.detachment": "Сегодня: насколько вам удалось отвлечься от работы вечером?",
      "planner.evening.fatiguePh": "1–5 (усталость вечером)",
      "planner.evening.taskStartPh": "1–5 (сложно начать?)",
      "planner.evening.procrastinationPh": "1–5 (откладывание)",
      "planner.evening.detachmentPh": "1–5 (отключиться от работы)",
    ...
    en: {
      ...
      "planner.tasks.reorderHint": "Drag tasks by the ⋮⋮ handle on the left to arrange them in the order you prefer.",
      ...
      "planner.evening.procrastination": "Today: how often did you put off starting tasks?",
      "planner.evening.detachment": "Today: how well were you able to disconnect from work this evening?",
      "planner.evening.fatiguePh": "1–5 (evening fatigue)",
      "planner.evening.taskStartPh": "1–5 (hard to start?)",
      "planner.evening.procrastinationPh": "1–5 (procrastination)",
      "planner.evening.detachmentPh": "1–5 (switch off from work)",
