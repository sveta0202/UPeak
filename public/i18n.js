(function () {
  ...
  var DICT = {
    ru: {
      ...
      "planner.recommendation.avoidLabel": "Лучше избегать",
      "planner.recommendation.improveLabel": "Что можно улучшить",
      ...
      "participate.consent.label": "Мне исполнилось 18 лет. Я ознакомился(ась) с",
      "participate.consent.link": "пользовательским соглашением и согласием на участие в исследовании",
      "participate.consent.suffix": "и принимаю его условия.",
      "participate.consent.error": "Подтвердите согласие, чтобы отправить заявку",
    ...
    en: {
      ...
      "planner.recommendation.avoidLabel": "Better to avoid",
      "planner.recommendation.improveLabel": "What you could improve",
      ...
      "participate.consent.label": "I am 18 or older. I have read the",
      "participate.consent.link": "user agreement and research consent",
      "participate.consent.suffix": "and accept its terms.",
      "participate.consent.error": "Please accept the agreement to submit your request",
