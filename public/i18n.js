(function () {
  ...
  var DICT = {
    ru: {
      ...
      "planner.tasks.moveUp": "Выше",
      "planner.tasks.moveDown": "Ниже",
      "planner.tasks.reorderHint": "Перетаскивайте задачи или используйте стрелки ↑/↓, чтобы выстроить удобный порядок.",
    ...
    en: {
      ...
      "planner.tasks.moveUp": "Move up",
      "planner.tasks.moveDown": "Move down",
      "planner.tasks.reorderHint": "Drag tasks or use ↑/↓ arrows to arrange them in the order you prefer.",
