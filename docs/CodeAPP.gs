...
var RECOMMENDATIONS_CATALOG_SEED = [
  ["emergency_recovery", "morning", "card", "Recovery"],
  ["plateau", "morning", "card", "Plateau"],
  ["growth", "morning", "card", "Growth"],
  ["growth:sleep_hours", "morning", "card", "Growth — sleep_hours"],
  ["growth:sleep_quality", "morning", "card", "Growth — sleep_quality"],
  ["growth:stress", "morning", "card", "Growth — stress"],
  ["growth:energy", "morning", "card", "Growth — energy"],
  ["single_issue", "morning", "card", "Single issue"],
  ["single_issue:stress", "morning", "card", "Single issue — stress"],
  ["single_issue:sleep_hours", "morning", "card", "Single issue — sleep_hours"],
  ["single_issue:sleep_quality", "morning", "card", "Single issue — sleep_quality"],
  ["single_issue:energy", "morning", "card", "Single issue — energy"],
  ["high", "morning", "card", "High"],
  ["high:sleep_tune", "morning", "card", "High — sleep_tune"],
